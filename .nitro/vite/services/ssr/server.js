...
function parseSegments(defaultCaseSensitive, data, route, start, node, depth, onRoute) {
  ...
  let cursor = start;
  {
    ...
    const caseSensitive = ((_a3 = route.options) == null ? void 0 : _a3.caseSensitive) ?? defaultCaseSensitive;
    const skipOnParamError = !!(((_c = (_b2 = route.options) == null ? void 0 : _b2.params) == null ? void 0 : _c.parse) && ((_e2 = (_d = route.options) == null ? void 0 : _d.skipRouteOnParseError) == null ? void 0 : _e2.params));
    while (cursor < length) {
...
function sortTreeNodes(node) {
  ...
  if ((_a3 = node.dynamic) == null ? void 0 : _a3.length) {
...
function extractParams(path, parts, leaf) {
  ...
  let nodeParts = null;
  const rawParams = {};
  let partIndex = ((_a3 = leaf.extract) == null ? void 0 : _a3.part) ?? 0;
  ...
  for (; nodeIndex < list.length; partIndex++, nodeIndex++, pathIndex++, segmentCount++) {
    ...
    if (node.kind === SEGMENT_TYPE_PARAM) {
      ...
      const preLength = ((_e2 = node.prefix) == null ? void 0 : _e2.length) ?? 0;
      ...
      const value = path.substring(
        currentPathIndex + (((_i = n2.prefix) == null ? void 0 : _i.length) ?? 0),
        path.length - (((_j = n2.suffix) == null ? void 0 : _j.length) ?? 0)
      );
...
function restoreScroll({
  ...
  const resolvedKey = key || ((_a3 = window.history.state) == null ? void 0 : _a3.__TSR_key);
...
const handleSerialError = (inner, index, err, routerCode) => {
  ...
  inner.updateMatch(matchId, (prev) => {
    var _a4, _b3;
    (_a4 = prev._nonReactive.beforeLoadPromise) == null ? void 0 : _a4.resolve();
...
const isBeforeLoadSsr = (inner, matchId, index, route) => {
  ...
  const parentMatchId = (_a3 = inner.matches[index - 1]) == null ? void 0 : _a3.id;
...
const executeHead = (inner, matchId, route) => {
  ...
  return Promise.all([
    (_b2 = (_a3 = route.options).head) == null ? void 0 : _b2.call(_a3, assetContext),
...
const runLoader = async (inner, matchId, index, route) => {
  ...
  try {
    ...
    try {
      ...
      const loaderResult = (_b2 = (_a3 = route.options).loader) == null ? void 0 : _b2.call(
        _a3,
      ...
      if (pendingPromise) await pendingPromise;
      if (isNotFound(e)) {
        await ((_e2 = (_d = route.options.notFoundComponent) == null ? void 0 : _d.preload) == null ? void 0 : _e2.call(_d));
      }
    ...
    if (preload && route2.options.preload === false) ;
      ...
      (async () => {
        ...
        try {
          ...
          (_a4 = match3._nonReactive.loaderPromise) == null ? void 0 : _a4.resolve();
  ...
  if (!route._componentsLoaded && route._componentsPromise === void 0) {
    const loadComponents = () => {
      ...
      for (const type of componentTypes) {
        const preload = (_a3 = route.options[type]) == null ? void 0 : _a3.preload;
...
function executeRewriteOutput(rewrite, url) {
  var _a3;
  const res = (_a3 = rewrite == null ? void 0 : rewrite.output) == null ? void 0 : _a3.call(rewrite, { url });
  if (res) {
    if (typeof res === "string") {
      return new URL(res);
    } else if (res instanceof URL) {
...
class RouterCore {
  ...
  constructor(options) {
      ...
      const build = (dest = {}) => {
        ...
        if (Object.keys(nextParams).length > 0) {
          for (const route of destRoutes) {
            const fn2 = ((_a3 = route.options.params) == null ? void 0 : _a3.stringify) ?? route.options.stringifyParams;
            if (fn2) {
              changedParams = true;
    ...
    this.navigate = async ({
      ...
      if (reloadDocument) {
        ...
        if (!rest.ignoreBlocker) {
          ...
          const blockers = ((_a3 = historyWithBlockers.getBlockers) == null ? void 0 : _a3.call(historyWithBlockers)) ?? [];
          for (const blocker of blockers) {
                  ...
                  this.startViewTransition(async () => {
                    ...
                    [
                      ...
                      matches.forEach((match) => {
                        var _a4, _b2;
                        (_b2 = (_a4 = this.looseRoutesById[match.routeId].options)[hook]) == null ? void 0 : _b2.call(
                          _a4,
                          match
                        );
                      });
    ...
    this.updateMatch = (id, updater) => {
      this.startTransition(() => {
        var _a3;
        const matchesKey = ((_a3 = this.state.pendingMatches) == null ? void 0 : _a3.some((d) => d.id === id)) ? "pendingMatches" : this.state.matches.some((d) => d.id === id) ? "matches" : this.state.cachedMatches.some((d) => d.id === id) ? "cachedMatches" : "";
        if (matchesKey) {
          this.__store.setState((s) => {
            var _a4;
            return {
              ...s,
              [matchesKey]: (_a4 = s[matchesKey]) == null ? void 0 : _a4.map(
    ...
    this.invalidate = (opts) => {
      const invalidate = (d) => {
        var _a3;
        if (((_a3 = opts == null ? void 0 : opts.filter) == null ? void 0 : _a3.call(opts, d)) ?? true) {
          return {
            ...d,
            invalid: true,
  ...
  matchRoutesInternal(next, opts) {
    ...
    for (let index = 0; index < matchedRoutes.length; index++) {
      ...
      const loaderDeps = ((_b2 = (_a3 = route.options).loaderDeps) == null ? void 0 : _b2.call(_a3, {
...
function extractStrictParams(route, referenceParams, parsedParams, accumulatedParams) {
  var _a3;
  const parseParams = ((_a3 = route.options.params) == null ? void 0 : _a3.parse) ?? route.options.parseParams;
  if (parseParams) {
...
function ScriptOnce({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "script",
    {
      nonce: (_a3 = router.options.ssr) == null ? void 0 : _a3.nonce,
...
const Match = reactExports.memo(function MatchImpl({
  ...
  const matchState = useRouterState({
    select: (s) => {
      ...
      return {
        ...
        resetKey: s.loadedAt,
        parentRouteId: (_a4 = s.matches[matchIndex - 1]) == null ? void 0 : _a4.routeId
      };
    },
  ...
  const routeNotFoundComponent = route.isRoot ? (
    ...
    route.options.notFoundComponent ?? ((_a3 = router.options.notFoundRoute) == null ? void 0 : _a3.options.component)
...
const MatchInner = reactExports.memo(function MatchInnerImpl({
  ...
  if (match._displayPending) {
    throw (_a3 = router.getMatch(match.id)) == null ? void 0 : _a3._nonReactive.displayPendingPromise;
  }
...
const Outlet = reactExports.memo(function OutletImpl() {
  ...
  const routeId = useRouterState({
    select: (s) => {
      var _a3;
      return (_a3 = s.matches.find((d) => d.id === matchId)) == null ? void 0 : _a3.routeId;
    }
  });
  const route = router.routesById[routeId];
  ...
  const childMatchId = useRouterState({
    select: (s) => {
      ...
      return (_a3 = matches[index + 1]) == null ? void 0 : _a3.id;
    }
  });
...
class ScriptBuffer {
  ...
  flush() {
    ...
    if (scriptsToInject && ((_a3 = this.router) == null ? void 0 : _a3.serverSsr)) {
...
function attachRouterServerSsrUtils({
  ...
  router.serverSsr = {
    ...
    injectScript: (script) => {
      var _a3;
      if (!script) return;
      const html = `<script${((_a3 = router.options.ssr) == null ? void 0 : _a3.nonce) ? ` nonce='${router.options.ssr.nonce}'` : ""}>${script}<\/script>`;
    ...
    dehydrate: async () => {
      ...
      const lastMatchId = (_a3 = matchesToDehydrate[matchesToDehydrate.length - 1]) == null ? void 0 : _a3.id;
      if (lastMatchId) {
...
function transformStreamWithRouter(router, appStream, opts) {
  var _a3, _b2;
  const serializationAlreadyFinished = ((_a3 = router.serverSsr) == null ? void 0 : _a3.isSerializationFinished()) ?? false;
  const initialBufferedHtml = (_b2 = router.serverSsr) == null ? void 0 : _b2.takeBufferedHtml();
  if (serializationAlreadyFinished && !initialBufferedHtml) {
    ...
    const cleanup2 = () => {
      ...
      (_a4 = router.serverSsr) == null ? void 0 : _a4.cleanup();
    };
    const safeClose2 = () => {
      if (isStreamClosed2) return;
      isStreamClosed2 = true;
      try {
        controller2 == null ? void 0 : controller2.close();
      } catch {
      }
    };
    const safeError2 = (error) => {
      ...
      isStreamClosed2 = true;
      try {
        controller2 == null ? void 0 : controller2.error(error);
      } catch {
      }
    };
    ...
    (async () => {
      ...
      try {
        while (true) {
          ...
          controller2 == null ? void 0 : controller2.enqueue(value);
        }
        if (cleanedUp2 || isStreamClosed2) return;
        (_a4 = router.serverSsr) == null ? void 0 : _a4.setRenderFinished();
        safeClose2();
        cleanup2();
      } catch (error) {
        if (cleanedUp2) return;
  ...
  function cleanup() {
    ...
    try {
      ...
      stopListeningToSerializationFinished == null ? void 0 : stopListeningToSerializationFinished();
    } catch {
    }
  ...
  if (!serializationAlreadyFinished) {
    stopListeningToInjectedHtml = router.subscribe("onInjectedHtml", () => {
      var _a4;
      if (cleanedUp || isStreamClosed) return;
      const html = (_a4 = router.serverSsr) == null ? void 0 : _a4.takeBufferedHtml();
      if (!html) return;
  ...
  (async () => {
    ...
    try {
      while (true) {
        ...
        if (!streamBarrierLifted) {
          if (chunkString.includes(TSR_SCRIPT_BARRIER_ID)) {
            ...
            (_a4 = router.serverSsr) == null ? void 0 : _a4.liftScriptBarrier();
          }
        }
      ...
      if (serializationFinished) {
        ...
        const timeoutMs = (opts == null ? void 0 : opts.timeoutMs) ?? DEFAULT_SERIALIZATION_TIMEOUT_MS;
...
function requireReactDomServer_node_production() {
  ...
  var util = require$$0, crypto = crypto$1, async_hooks = require$$2, React2 = requireReact(), ReactDOM = requireReactDom(), stream = Stream, REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler"), REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy"), REACT_SCOPE_TYPE = Symbol.for("react.scope"), REACT_ACTIVITY_TYPE = Symbol.for("react.activity"), REACT_LEGACY_HIDDEN_TYPE = Symbol.for("react.legacy_hidden"), REACT_MEMO_CACHE_SENTINEL = Symbol.for("react.memo_cache_sentinel"), REACT_VIEW_TRANSITION_TYPE = Symbol.for("react.view_transition"), MAYBE_ITERATOR_SYMBOL = Symbol.iterator;
  function getIteratorFn(maybeIterable) {
    if (null === maybeIterable || "object" !== typeof maybeIterable) return null;
    maybeIterable = MAYBE_ITERATOR_SYMBOL && maybeIterable[MAYBE_ITERATOR_SYMBOL] || maybeIterable["@@iterator"];
    return "function" === typeof maybeIterable ? maybeIterable : null;
...
async function executeMiddleware$1(middlewares, env, opts) {
  var _a3;
  const globalMiddlewares = ((_a3 = getStartOptions()) == null ? void 0 : _a3.functionMiddleware) || [];
  ...
  return {
    ...
    options: {
      ...
      client: async ({ next, sendContext, fetch, ...ctx }) => {
        ...
        const res = await ((_a3 = options.extractedFn) == null ? void 0 : _a3.call(options, payload));
        return next(res);
      },
      server: async ({ next, ...ctx }) => {
        var _a3;
        const result = await ((_a3 = options.serverFn) == null ? void 0 : _a3.call(options, ctx));
        return next({
          ...ctx,
          result
        });
...
var HTTPError = class HTTPError2 extends Error {
  constructor(arg1, arg2) {
    ...
    const rawHeaders = (details == null ? void 0 : details.headers) || ((_d = details == null ? void 0 : details.cause) == null ? void 0 : _d.headers);
    this.headers = rawHeaders ? new Headers(rawHeaders) : void 0;
    this.unhandled = (details == null ? void 0 : details.unhandled) ?? ((_e2 = details == null ? void 0 : details.cause) == null ? void 0 : _e2.unhandled) ?? void 0;
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DO3b8gvg.js");
...
const manifest = { "44f1e9ede9f4237ddb921cff66b518d0f98153203c250620b2dcc5419494bf9e": {
  ...
  importer: () => import("./assets/functions-CeM_x4oM.js")
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BPDJsAnB.js").then((n2) => n2.b);
